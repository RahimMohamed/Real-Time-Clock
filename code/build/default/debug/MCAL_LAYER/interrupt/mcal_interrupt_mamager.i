# 1 "MCAL_LAYER/interrupt/mcal_interrupt_mamager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_LAYER/interrupt/mcal_interrupt_mamager.c" 2
...
# 16 "MCAL_LAYER/interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_LAYER/interrupt/../GPIO/../device_config/device_config.h" 1
# 16 "MCAL_LAYER/interrupt/../GPIO/hal_gpio.h" 2
# 42 "MCAL_LAYER/interrupt/../GPIO/hal_gpio.h"
typedef enum{ LOW=0,
              HIGH
}logic_t;
...
void TMR2_ISR (void);
void TMR3_ISR (void);
# 7 "MCAL_LAYER/interrupt/mcal_interrupt_mamager.c" 2
# 55 "MCAL_LAYER/interrupt/mcal_interrupt_mamager.c"
void __attribute__((picinterrupt(("")))) InterruptManger (void){
...
# 91 "MCAL_LAYER/interrupt/mcal_interrupt_mamager.c"
}
